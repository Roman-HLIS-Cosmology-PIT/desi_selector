...
z_range = [0, 2]
z_grid_points = 481
path_desi_tracer = {'path':'/pscratch/sd/y/yoki/desi_like_data_diffsky/data/desi_sv_data/desi_elg_ts_zenodo/main-800coaddefftime1200-nz-zenodo.ecsv'}
path_sim = '/global/cfs/cdirs/hacc/OpenCosmo/LastJourney/synthetic_galaxies/'        
calibration = 'hlwas_cosmos_260215_02_17_2026'
select_biggest = True
threshold_col = 'log_sfr_times_wmass'
reload_oc = False
weight_arr = np.array([0, 8, 8.5, 9, 9.5, 10])
...
for weight in weight_arr:
    ...
    path_mock_output = f'/global/homes/y/yoki/roman/desi_like_samples/diffsky/data/mock_cats/{desi_tracer}/mock_{desi_tracer}_cat_{calibration}_{threshold_col}_{sim_area}deg2_{weight}weight.parquet'
    path_rand_output = f'/global/homes/y/yoki/roman/desi_like_samples/diffsky/data/mock_cats/{desi_tracer}/rand_{desi_tracer}_cat_{calibration}_{threshold_col}_{sim_area}deg2_{weight}weight.parquet'
    mock_cat.to_parquet(path_mock_output)
    rand_cat.to_parquet(path_rand_output)

    # args to be passed into auto-correlation function
    z_range_clustering = [[0.8, 1.1], [1.1, 1.6]]
    NBINS = 100
    MIN_SEP = 1
    MAX_SEP = 200
    ...
    for z_range_cluster in z_range_clustering:
        ...
        path_corr_results = f'/global/homes/y/yoki/roman/desi_like_samples/diffsky/data/corr_results/{desi_tracer}/z_{z_range_cluster[0]}_{z_range_cluster[1]}_{calibration}_{threshold_col}_{sim_area}deg2_{weight}weight.npz'
